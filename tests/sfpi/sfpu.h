...
extern __rvtt_vec_t sfpu_rvtt_sfpsetexp_v(__rvtt_vec_t& dst, const __rvtt_vec_t& src);
extern __rvtt_vec_t sfpu_rvtt_sfpsetman_i(unsigned int imm, const __rvtt_vec_t& v);
extern __rvtt_vec_t sfpu_rvtt_sfpsetman_v(__rvtt_vec_t& dst, const __rvtt_vec_t& src);
extern __rvtt_vec_t sfpu_rvtt_sfpabs(const __rvtt_vec_t& v, unsigned int mod1);
extern __rvtt_vec_t sfpu_rvtt_sfpand(__rvtt_vec_t& dst, const __rvtt_vec_t& src);
extern __rvtt_vec_t sfpu_rvtt_sfpor(__rvtt_vec_t& dst, const __rvtt_vec_t& src);
...
extern __rvtt_vec_t sfpu_rvtt_sfpaddi(__rvtt_vec_t& v, unsigned short imm, unsigned int mod1);
...
extern __rvtt_vec_t sfpu_rvtt_sfpshft_i(__rvtt_vec_t& dst, int shift);
...
extern __rvtt_vec_t sfpu_rvtt_sfplut(const __rvtt_vec_t& l0, const __rvtt_vec_t& l1, const __rvtt_vec_t& l2, __rvtt_vec_t& dst, unsigned short mod0);
