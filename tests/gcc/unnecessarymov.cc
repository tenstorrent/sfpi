...
void whymov()
{
    v64sf a = __builtin_riscv_sfploadi(nullptr, 4, 3);
    v64sf tmp = __builtin_riscv_sfpload(nullptr, 1, 0);
    __builtin_riscv_sfppushc();
    __builtin_riscv_sfpsetcc_v(tmp, 6);
    a = __builtin_riscv_sfploadi_lv(nullptr, a, 4, 28);
    __builtin_riscv_sfppopc();
    v64sf b = __builtin_riscv_sfploadi(nullptr, 0, 17152);
    __builtin_riscv_sfppushc();
    __builtin_riscv_sfpiadd_i(nullptr, a, -29, 1);
    b = __builtin_riscv_sfploadi_lv(nullptr, b, 0, 17408);
    __builtin_riscv_sfppopc();
