...
void smoke()
{
    ...
    a = __builtin_rvtt_gs_sfpload(nullptr, 1, 0);
    b = __builtin_rvtt_gs_sfpload(nullptr, 1, 16);
    ...
    __builtin_rvtt_gs_sfpsetcc_i(3, 12);
    ...
    v64sf v1, v2;
    __builtin_rvtt_gs_sfpstore(nullptr, b, 2, 1);
    v1 = __builtin_rvtt_gs_sfpload(nullptr, 2, 0);
    v2 = __builtin_rvtt_gs_sfpmov(v1, SFPMOV_MOD1_COMPSIGN);

    __builtin_rvtt_gs_sfpstore(nullptr, c, 2, 2);
    __builtin_rvtt_gs_sfpstore(nullptr, d, 2, 3);
    __builtin_rvtt_gs_sfpstore(nullptr, v2, 2, 10);

    v2 = __builtin_rvtt_gs_sfpexexp(v1, SFPEXEXP_MOD1_DEBIAS);
    v2 = __builtin_rvtt_gs_sfpexman(v1, SFPEXMAN_MOD1_PAD8);

    v2 = __builtin_rvtt_gs_sfpsetexp_i(nullptr, 23, v1);
    v2 = __builtin_rvtt_gs_sfpsetexp_v(v2, v1);

    v2 = __builtin_rvtt_gs_sfpsetman_i(nullptr, 23, v1);
    ...
    v2 = __builtin_rvtt_gs_sfpmuli(nullptr, v2, 32, 1);
    v2 = __builtin_rvtt_gs_sfpaddi(nullptr, v2, 32, 0);

    v2 = __builtin_rvtt_gs_sfpdivp2(nullptr, 32, v1, 1);
    ...
    __builtin_rvtt_gs_sfpstore(nullptr, v1, 2, 6);
    __builtin_rvtt_gs_sfpstore(nullptr, v2, 2, 8);

    v2 = __builtin_rvtt_gs_sfpiadd_v(v2, lr13, 4);
...
void smoke_live()
{
    ...
    a = __builtin_rvtt_gs_sfpload(nullptr, 1, 0);
    a = __builtin_rvtt_gs_sfpload_lv(nullptr, a, 1, 0);

    d = __builtin_rvtt_gs_sfpload(nullptr, 1, 0);
    ...
    a = __builtin_rvtt_gs_sfpsetexp_i_lv(nullptr, a, 23, d);
    a = __builtin_rvtt_gs_sfpsetman_i_lv(nullptr, a, 23, d);

    a = __builtin_rvtt_gs_sfpabs_lv(a, d, SFPABS_MOD1_FLOAT);
    a = __builtin_rvtt_gs_sfpnot_lv(a, d);

    a = __builtin_rvtt_gs_sfpdivp2_lv(nullptr, a, 32, d, 1);
    ...
    a = __builtin_rvtt_gs_sfpsetsgn_i_lv(nullptr, a, 10, d);
}
...
void smokier()
{
    ...
    __builtin_rvtt_gs_sfpstore(nullptr, a, 2, 20);
    __builtin_rvtt_gs_sfpstore(nullptr, b, 2, 20);
    __builtin_rvtt_gs_sfpstore(nullptr, c, 2, 20);
    __builtin_rvtt_gs_sfpstore(nullptr, d, 2, 20);

    v64sf e = __builtin_rvtt_gs_sfpload(nullptr, 1, 20);
    v64sf f = __builtin_rvtt_gs_sfpload(nullptr, 1, 20);
    v64sf g = __builtin_rvtt_gs_sfpload(nullptr, 1, 20);

    __builtin_rvtt_gs_sfpstore(nullptr, e, 2, 20);
    __builtin_rvtt_gs_sfpstore(nullptr, f, 2, 20);
    __builtin_rvtt_gs_sfpstore(nullptr, g, 2, 20);
    __builtin_rvtt_gs_sfpkeepalive(c, 2);
}
...
void smokiest()
{
    ...
    a = __builtin_rvtt_gs_sfpload(nullptr, 2, 0);
    b = __builtin_rvtt_gs_sfpload(nullptr, 2, 1);

    orig_a = a;
    a = b;
    a = __builtin_rvtt_gs_sfpsetexp_v(a, orig_a);
   
    __builtin_rvtt_gs_sfpstore(nullptr, a, 2, 6);
}
