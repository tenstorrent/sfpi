...
int main(int argc, char* argv[])
{
    ...
    __builtin_rvtt_gs_sfpsetcc_i(0 + pass_offset, 1);
    __builtin_rvtt_gs_sfpsetcc_i(0x0FFF + pass_offset, 1);
    __builtin_rvtt_gs_sfppopc();

    // Unsigned 12 bit
    __builtin_rvtt_gs_sfpencc(0 + pass_offset, 2);
    __builtin_rvtt_gs_sfpencc(0x0FFF + pass_offset, 2);
