...
void smoke()
{
    ...
    a = __builtin_rvtt_wh_sfpload(nullptr, 1, 0);
    b = __builtin_rvtt_wh_sfpload(nullptr, 1, 16);
    c = __builtin_rvtt_wh_sfpload(nullptr, 1, 32);
    ...
    d = __builtin_rvtt_wh_sfpmad(  a,   b,   c, 1);
    d = __builtin_rvtt_wh_sfpmad(  a,   b, lr6, 1);
    d = __builtin_rvtt_wh_sfpmad(  a, lr7,   c, 1);
    d = __builtin_rvtt_wh_sfpmad(  a, lr7, lr6, 1);
    d = __builtin_rvtt_wh_sfpmad(lr8,   b,   c, 1);
    d = __builtin_rvtt_wh_sfpmad(lr8,   b, lr6, 1);
    d = __builtin_rvtt_wh_sfpmad(lr8, lr7,   c, 1);
    d = __builtin_rvtt_wh_sfpmad(lr8, lr7, lr6, 1);

    d = __builtin_rvtt_wh_sfpmul(lr8, lr7, 1);
    d = __builtin_rvtt_wh_sfpadd(lr8, lr7, 1);
    ...
    v2 = __builtin_rvtt_wh_sfpmuli(nullptr, v2, 32, 1);
...
void smoke_live()
{
    ...
    a = __builtin_rvtt_wh_sfpload(nullptr, 1, 0);
    a = __builtin_rvtt_wh_sfpload_lv(nullptr, a, 1, 0);

    d = __builtin_rvtt_wh_sfpload(nullptr, 1, 0);
    d = __builtin_rvtt_wh_sfpmad_lv(d,   a,   a,   a, 1);
...
void smokier()
{
    ...
    v64sf d = __builtin_rvtt_wh_sfpload(nullptr, 1, 20);
...
void smokiest()
{
    ...
    a = __builtin_rvtt_wh_sfpload(nullptr, 2, 0);
    b = __builtin_rvtt_wh_sfpload(nullptr, 2, 1);
