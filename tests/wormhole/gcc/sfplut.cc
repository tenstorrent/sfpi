...
int main(int argc, char* argv[])
{
    ...
    l0 = __builtin_rvtt_wh_sfpxloadi(nullptr, 0, 12);
    l1 = __builtin_rvtt_wh_sfpxloadi(nullptr, 0, 13);
    l2 = __builtin_rvtt_wh_sfpxloadi(nullptr, 0, 14);
    l3 = __builtin_rvtt_wh_sfpxloadi(nullptr, 0, 6);
