...
void whymov()
{
    v64sf a = __builtin_rvtt_wh_sfpxloadi(nullptr, 4, 3);
    v64sf tmp = __builtin_rvtt_wh_sfpload(nullptr, 1, 0, 0);
    __builtin_rvtt_wh_sfppushc(0);
    __builtin_rvtt_wh_sfpsetcc_v(tmp, 6);
    a = __builtin_rvtt_wh_sfpxloadi_lv(nullptr, a, 4, 28);
    __builtin_rvtt_wh_sfppopc(0);
    v64sf b = __builtin_rvtt_wh_sfpxloadi(nullptr, 0, 17152);
    __builtin_rvtt_wh_sfppushc(0);
    __builtin_rvtt_wh_sfpiadd_i(nullptr, a, -29, 1);
    b = __builtin_rvtt_wh_sfpxloadi_lv(nullptr, b, 0, 17408);
    __builtin_rvtt_wh_sfppopc(0);
