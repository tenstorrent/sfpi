...
#define __builtin_rvtt_sfpxcond(i) __builtin_rvtt_gs_sfpxcond(i)
...
#define __builtin_rvtt_sfpxiadd_i(src, imm12, mod1) __builtin_rvtt_gs_sfpxiadd_i((void *)ckernel::instrn_buffer, src, imm12, mod1)
