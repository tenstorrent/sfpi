...
#define __builtin_rvtt_sfpshft_i(dst, imm12) __builtin_rvtt_wh_sfpshft_i(ckernel::instrn_buffer, dst, imm12, 0, 0)
...
constexpr unsigned int SFPSTORE_MOD0_FMT_INT32 = 12;
