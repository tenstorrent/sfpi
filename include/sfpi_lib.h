...
namespace impl_ {
sfpi_inline constexpr unsigned rounding_to_stochrnd_rnd (Rounding mode) {
  return mode == Rounding::NearestEven ? SFPSTOCHRND_RND_EVEN
      : mode == Rounding::Stochastic ? SFPSTOCHRND_RND_STOCH
#if __riscv_xtttensixbh || __riscv_xtttensixqsr
      : mode == Rounding::Zero ? SFPSTOCHRND_RND_ZERO
#endif
      : 0x16; // Bad value, compilation error
}
sfpi_inline constexpr unsigned rounding_to_cast_rnd (Rounding mode) {
  return mode == Rounding::NearestEven ? SFPCAST_MOD1_INT32_TO_FP32_RNE
      : mode == Rounding::Stochastic ? SFPCAST_MOD1_INT32_TO_FP32_RNS
      : 0x16; // Bad value, compilation error
}
}

sfpi_inline vFloat int32_to_float (vInt in, Rounding rounding = Rounding::Stochastic) {
...
sfpi_inline vFloat float_to_fp16a (vFloat in, Rounding rounding = Rounding::Stochastic) {
  return __builtin_rvtt_sfpstochrnd_i
      (in.get(), 0,
       SFPSTOCHRND_MOD1_FP32_TO_FP16A, impl_::rounding_to_stochrnd_rnd (rounding));
}

sfpi_inline vFloat float_to_fp16b (vFloat in, Rounding rounding = Rounding::Stochastic) {
  return __builtin_rvtt_sfpstochrnd_i
      (in.get(), 0,
       SFPSTOCHRND_MOD1_FP32_TO_FP16B, impl_::rounding_to_stochrnd_rnd (rounding));
}

sfpi_inline vUInt float_to_uint16 (vFloat in, Rounding rounding = Rounding::Stochastic) 
{
  return __builtin_rvtt_sfpstochrnd_i
      (in.get(), 0,
...
sfpi_inline vInt float_to_int16 (vFloat in, Rounding rounding = Rounding::Stochastic) {
  return __builtin_rvtt_sfpstochrnd_i
      (in.get(), 0,
       SFPSTOCHRND_MOD1_FP32_TO_INT16, impl_::rounding_to_stochrnd_rnd (rounding));
}

sfpi_inline vUInt float_to_uint8 (vFloat in, Rounding rounding = Rounding::Stochastic) {
  return __builtin_rvtt_sfpstochrnd_i
      (in.get(), 0,
       SFPSTOCHRND_MOD1_FP32_TO_UINT8, impl_::rounding_to_stochrnd_rnd (rounding));
}

sfpi_inline vInt float_to_int8 (vFloat in, Rounding rounding = Rounding::Stochastic) {
  return __builtin_rvtt_sfpstochrnd_i
      (in.get(), 0,
       SFPSTOCHRND_MOD1_FP32_TO_INT8, impl_::rounding_to_stochrnd_rnd (rounding));
}

sfpi_inline vUInt int32_to_uint8 (vInt in, vUInt descale, Rounding rounding = Rounding::Stochastic) {
  return __builtin_rvtt_sfpstochrnd_v
      (in.get(), descale.get(),
       SFPSTOCHRND_MOD1_INT32_TO_UINT8, impl_::rounding_to_stochrnd_rnd (rounding));
}

sfpi_inline vUInt int32_to_uint8 (vInt in, unsigned descale, Rounding rounding = Rounding::Stochastic) {
  return __builtin_rvtt_sfpstochrnd_i
      (in.get(), descale,
       SFPSTOCHRND_MOD1_INT32_TO_UINT8, impl_::rounding_to_stochrnd_rnd (rounding));
}

sfpi_inline vInt int32_to_int8 (vInt in, vUInt descale, Rounding rounding = Rounding::Stochastic) {
  return __builtin_rvtt_sfpstochrnd_v
      (in.get(), descale.get(),
       SFPSTOCHRND_MOD1_INT32_TO_INT8, impl_::rounding_to_stochrnd_rnd (rounding));
}

sfpi_inline vInt int32_to_int8 (vInt in, unsigned descale, Rounding rounding = Rounding::Stochastic) {
  return __builtin_rvtt_sfpstochrnd_i
      (in.get(), descale,
       SFPSTOCHRND_MOD1_INT32_TO_INT8, impl_::rounding_to_stochrnd_rnd (rounding));
}
