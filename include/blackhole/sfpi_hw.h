...
#define __builtin_rvtt_sfpload(mod0, mode, addr) __builtin_rvtt_bh_sfpload((void *)ckernel::instrn_buffer, mod0, mode, addr, 0, 0)

#define __builtin_rvtt_sfppreservelreg(x, n) __builtin_rvtt_bh_sfppreservelreg(x, n)

#define __builtin_rvtt_sfpxloadi(mod0, imm16) __builtin_rvtt_bh_sfpxloadi((void *)ckernel::instrn_buffer, mod0, imm16, 0, 0)
#define __builtin_rvtt_sfpstore(src, mod0, mode, addr) __builtin_rvtt_bh_sfpstore((void *)ckernel::instrn_buffer, src, mod0, mode, addr, 0, 0)
#define __builtin_rvtt_sfpmov(src, mod1) __builtin_rvtt_bh_sfpmov(src, mod1)
#define __builtin_rvtt_sfpnop() __builtin_rvtt_bh_sfpnop()
#define __builtin_rvtt_sfpillegal() __builtin_rvtt_bh_sfpillegal()
...
#define __builtin_rvtt_sfpxfcmps(v, f, mod1) __builtin_rvtt_bh_sfpxfcmps((void *)ckernel::instrn_buffer, v, f, 0, 0, mod1)
...
#define __builtin_rvtt_sfpsetexp_i(imm12, src) __builtin_rvtt_bh_sfpsetexp_i((void *)ckernel::instrn_buffer, imm12, 0, 0, src)
#define __builtin_rvtt_sfpsetexp_v(dst, src) __builtin_rvtt_bh_sfpsetexp_v(dst, src)

#define __builtin_rvtt_sfpsetman_i(imm12, src, mod) __builtin_rvtt_bh_sfpsetman_i((void *)ckernel::instrn_buffer, imm12, 0, 0, src, mod)
...
#define __builtin_rvtt_sfpdivp2(imm12, src, mod1) __builtin_rvtt_bh_sfpdivp2((void *)ckernel::instrn_buffer, imm12, 0, 0, src, mod1)
...
#define __builtin_rvtt_sfpsetsgn_i(imm12, src) __builtin_rvtt_bh_sfpsetsgn_i((void *)ckernel::instrn_buffer, imm12, 0, 0, src)
...
#define __builtin_rvtt_sfpstochrnd_i(mode, imm8, srcc, mod1) __builtin_rvtt_bh_sfpstochrnd_i((void *)ckernel::instrn_buffer, mode, imm8, 0, 0, srcc, mod1)
