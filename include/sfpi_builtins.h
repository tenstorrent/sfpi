...
#define __builtin_rvtt_sfpdivp2(src, imm12, mod1) __builtin_rvtt_sfpdivp2(ckernel::instrn_buffer, src, imm12, 0, 0, mod1)
#define __builtin_rvtt_sfpstochrnd_i(srcc, imm8, mode, mod1) __builtin_rvtt_sfpstochrnd_i(ckernel::instrn_buffer, srcc, imm8, 0, 0, mode, mod1)
